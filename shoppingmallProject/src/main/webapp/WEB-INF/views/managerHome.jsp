...
<body>
	...
	<div class="managerMenu">
		<button type="button" class="btn btn-light"
			onClick="return muldelete()">게시글삭제</button>
		<button type="button" class="btn btn-light"
			onClick="fn_eventAdd(this.form)">이벤트배너 등록</button>
		<button type="button" class="btn btn-light"
			...
			<c:choose>
				<c:when test="${!empty allList}">
					<div class="album py-3 bg-light">
						<div class="container">
							<div class="row">
								<c:forEach var="allList" items="${allList}" varStatus="status ">
									<div class="col-md-4">
										<div class="card mb-4 shadow-sm">
