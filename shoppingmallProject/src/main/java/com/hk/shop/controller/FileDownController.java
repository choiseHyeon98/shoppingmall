...
public class FileDownController {
   ...
   //파일다운로드
   @RequestMapping(value="/fileDownloadReview")
   public void fileDownloadReview(HttpServletRequest request, HttpServletResponse response,@RequestParam("reviewPhoto")String reviewPhoto) throws Exception {
      
      String fileName = reviewPhoto;
      String realFileName="";
      System.out.println("fileName="+fileName);
      ...
      realFileName = "C:\\board\\reviewPhoto\\"+fileName;
      System.out.println("realFileName="+ realFileName);
      File file1 = new File(realFileName);
      if (!file1.exists()) {
         return ;
   ...
   //파일다운로드
   @RequestMapping(value="/fileDownloadDetail")
   public void fileDownloadDetail(HttpServletRequest request, HttpServletResponse response,@RequestParam("detailsImg")String detailsImg) throws Exception {
      
      String fileName = detailsImg;
      String realFileName="";
      System.out.println("fileName="+fileName);
